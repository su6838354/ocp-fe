...
misc.func.user.create_user_admin=function(param,succ_cb,fail_cb){
	misc.ajax.cdPost(misc.api.user.create_user_admin, JSON.stringify(param), function(res){
        succ_cb && succ_cb(res);
    }, function(err){
        fail_cb && fail_cb(err);
    });
...
misc.func.activity.update_act_join_log_extra=function(param,succ_cb,fail_cb){
    misc.ajax.cdPost(misc.api.activity.update_act_join_log_extra, JSON.stringify(param), function(res){
        succ_cb && succ_cb(res);
    }, function(err){
        fail_cb && fail_cb(err);
    });
...
userObj.initFooter = function(){
	var arr = [
	'<div class="footer-inner"> 2017-2018 &copy; 一卡通</div>',
...
userObj.logIn=misc.func._user.login;
