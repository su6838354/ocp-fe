...
p.initVar=function() {
	...
	$('#select_year').on('click', function(event) {
...
p.showMyCheckLog = function(){
	mark=0;
	$star_count_log.empty()
	var checkinarr=user.userInfo.get("checkin"+(currentYear==2017?"":currentYear))
	if(checkinarr&&checkinarr.length&&checkinarr[0]=="true"){
		p.commonCheckLog();
	}
};
